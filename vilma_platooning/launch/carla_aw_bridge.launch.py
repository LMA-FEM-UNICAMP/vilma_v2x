...
def launch_setup(context, *args, **kwargs):
    ...
    ackermann_launch_ego = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(
            get_package_share_directory('carla_ackermann_control')),
            '/carla_ackermann_control.launch.py']))

    ackermann_launch_leader = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(
            get_package_share_directory('carla_ackermann_control')),
            '/carla_ackermann_control.launch.py']),
            launch_arguments={
...
def generate_launch_description():
    ...
    ego_name_arg = launch.actions.DeclareLaunchArgument(
            ...
            default_value=['ego_vehicle','leader_vehicle','hero0', 'hero1', 'hero2',
